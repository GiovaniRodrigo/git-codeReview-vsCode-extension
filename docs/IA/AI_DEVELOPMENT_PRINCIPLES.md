# Principios de Desenvolvimento com IA - Extensao de Code Review

Este documento define a mentalidade e os limites para uso de IA no desenvolvimento da **Extensao de Code Review**.
